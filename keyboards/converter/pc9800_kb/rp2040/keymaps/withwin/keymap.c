...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	LAYOUT( \
		KC_ESC , JP_Q   , JP_F   , JP_COMM, KC_MINUS, KC_NO  , KC_NO, KC_LSFT, \
		JP_1   , JP_W   , JP_G   , JP_DOT , KC_SLASH, KC_LALT, KC_NO, MYCAPS , \
		JP_2   , JP_E   , JP_H   , JP_SLSH, KC_KP_7 , KC_F11 , KC_F1, JP_KANA, \
		JP_3   , JP_R   , JP_J   , JP_MINS, KC_KP_8 , KC_F12 , KC_F2, KC_LWIN, \
		JP_4   , JP_T   , JP_K   , KC_SPC , KC_KP_9 , KC_F13 , KC_F3, KC_LCTL, \
		JP_5   , JP_Y   , JP_L   , KC_RALT, KC_ASTR , KC_F14 , KC_F4, \
