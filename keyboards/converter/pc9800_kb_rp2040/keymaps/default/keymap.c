...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	LAYOUT( \
		KC_ESC , JP_Q   , JP_F   , JP_COMM , KC_MINUS, KC_PDOT, KC_NO , KC_LEFT_SHIFT, \
		...
		JP_7   , JP_I   , JP_COLN, KC_PGDN , KC_KP_5 , KC_NO  , KC_F6 , \
		JP_8   , JP_O   , JP_RBRC, KC_INS  , KC_KP_6 , KC_NO  , KC_F7 , \
		JP_9   , JP_P   , JP_Z   , KC_DEL  , KC_PLUS , KC_NO  , KC_F8 , \
		JP_0   , JP_AT  , JP_X   , KC_UP   , KC_KP_1 , KC_NO  , KC_F9 , \
		JP_MINS, JP_LBRC, JP_C   , KC_LEFT , KC_KP_2 , KC_NO  , KC_F10, \
		JP_CIRC, KC_ENT , JP_V   , KC_RGHT , KC_KP_3 , \
		JP_YEN , JP_A   , JP_B   , KC_DOWN , KC_PEQL , \
		KC_BSPC, JP_S   , JP_N   , KC_NUM  , KC_KP_0 , KC_HOME, \
