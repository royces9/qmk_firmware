...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	LAYOUT( \
		KC_ESC , KC_Q   , KC_F   , KC_COMM   , KC_MINUS, KC_PDOT, KC_NO, KC_LEFT_SHIFT, \
		...
		KC_4   , KC_T   , KC_K   , KC_SPC    , KC_KP_9 , KC_F13 , KC_F3, KC_LEFT_CTRL , \
		...
		KC_BSPC, KC_S   , KC_N   , KC_NUM_LOCK, KC_KP_0 , KC_HOME, \
